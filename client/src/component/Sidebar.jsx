  ...
  return (
    <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white'>
       ...
       <div  title='add friends' onClick={()=>setOpenSearchUser(true)} className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded'>
          ...
          <div >
            <button className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded-full ' title={user?.name} onClick={()=>setEditUserOpen(true)}>
                <Avatar width={40}
                name={user?.name}
...

               {
                  allUser.length === 0 && (
                     <div className='mt-12'>
                        ...
                        <p className="text-lg text-center text-slate-400 mx-auto">Explore users to start a conversation with...</p>
                        </div>
                  )
               }
