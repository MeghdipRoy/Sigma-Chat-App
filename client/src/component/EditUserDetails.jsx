...
const handleSubmit = async(e)=>{
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 bg-grey-700 bg-opacity-40 flex justify-center items-center z-10'
        ...
        <form className='grid gap-3 mt-3' onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <div className='my-1 flex items-center gap-4'>
                    ...
                    <button className='font-semibold' onClick={handlOpenUploadPhoto}>Change Photo</button>
                    <input type="file"
                    id = 'profile_pic'
                    className='hidden'
